			...
			<div className='container header__container'>
				...
				<ul className='header__links list-reset'>
					<li className='header__links__item'>
						<button
							className='button-reset header__links__item__btn header__links__item__btn--search'
					...
					<li className='header__links__item header__links__item--profile'>
						{isAuth ? (
							...
							<button
								className='button-reset header__links__item__btn header__links__item__btn--profile'
