...
import { IProductItemActionButtonProps } from '@/types/elements';
import styles from '@/styles/product-item-action-button/index.module.scss';
...
const ProductItemActionButton = ({
	...
	return (
		<div className={styles.actions}>
			<button
				className={`button-reset ${styles.actions__btn} ${styles[iconClass]}`}
				onClick={callback}
