      ...
      <section className={styles.policy}>
        <div className='container'>
          ...
          <p>
            ...
            физическое лицо,&nbsp; потребитель товаров/услуг ООО «Алов»,
            далее «Компания».
          </p>
          <p>
            ...
            В рамках настоящего документа Операторами являются ООО «Алов»
            (Продавец) - 14200, Московская область, Домодедово, а также другие организации, с
          ...
          <p>
            ...
            Клиентов  ООО «Алов» (далее — Положение) разработано в
          ...
          <ul>
            ...
            <li>
              ...
              оформления бизнес–процессов при продаже зажигалок;
            </li>
            <li>
              формирования единой клиентской базы покупателей зажигалок&nbsp;
              для маркетинга;
            </li>
            ...
            <li>
              изучения конъюнктуры рынка зажигалог;
            </li>
            <li>
            ...
            <li>
              ...
              предлагаемых Компанией зажигалок, проводимых бонусных, мероприятий,
